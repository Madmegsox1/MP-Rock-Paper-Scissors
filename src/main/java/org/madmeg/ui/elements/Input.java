...
public final class Input extends Element {
    ...
    public Input(int x, int y, int w, int h, Gui parent, Color c, Color c2, Color c3, float boarderRadius,String text, Font font) {
        super(x, y, w, h, parent);
        this.color = c;
        this.textColor = c2;
        this.text = text;
    ...
    public void render(RenderEvent event) {
        RenderEngine.drawQuadA(new Vector2(x - boarderRadius, y - boarderRadius), w + boarderRadius*2, h + boarderRadius*2, borderColor);
